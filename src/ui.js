...
export const I18N = {
  en: {
    ...
    reportBrandSub: "Quant Portfolio Analytics",
    reportNonAdvisory: "Personal analytics report — not investment advice.",
    reportPortfolio: "Portfolio",
    reportPortfolioDefault: "Active portfolio",
    reportAnalysisPeriod: "Analysis period",
    reportProxyConnected: "Market data proxy: Connected",
    reportSecSummary: "Portfolio Summary",
    reportSecMetrics: "Performance & Risk Metrics",
    reportSecAllocation: "Allocation & Exposure",
    reportSecHoldings: "Holdings Detail",
    reportSecNotes: "Notes",
    reportSecMethodology: "Methodology & Disclaimer",
    reportEmpty: "No holdings available for report.",
    reportMethodologyBody: "Metrics are derived from historical price data over the selected analysis period. Returns are annualized; volatility is the annualized standard deviation of daily returns; Sharpe and Sortino use the configured risk-free rate; max drawdown is the largest peak-to-trough decline. Allocation and exposure breakdowns are descriptive summaries of current holdings only. This report is generated locally from data available at generation time and may use delayed or fallback data.",
  ...
  tr: {
    ...
    reportBrandSub: "Quant Portfolio Analytics",
    reportNonAdvisory: "Kişisel analiz raporu — yatırım tavsiyesi değildir.",
    reportPortfolio: "Portföy",
    reportPortfolioDefault: "Aktif portföy",
    reportAnalysisPeriod: "Analiz dönemi",
    reportProxyConnected: "Piyasa verisi proxy'si: Bağlı",
    reportSecSummary: "Portföy Özeti",
    reportSecMetrics: "Performans ve Risk Metrikleri",
    reportSecAllocation: "Dağılım ve Maruziyet",
    reportSecHoldings: "Varlık Detayı",
    reportSecNotes: "Notlar",
    reportSecMethodology: "Metodoloji ve Uyarı",
    reportEmpty: "Rapor için varlık bulunmuyor.",
    reportMethodologyBody: "Metrikler, seçilen analiz dönemindeki tarihsel fiyat verilerinden türetilir. Getiriler yıllıklandırılır; oynaklık günlük getirilerin yıllıklandırılmış standart sapmasıdır; Sharpe ve Sortino yapılandırılmış risksiz faiz oranını kullanır; maksimum düşüş en büyük zirve-dip kaybıdır. Dağılım ve maruziyet kırılımları yalnızca mevcut varlıkların betimleyici özetleridir. Bu rapor, oluşturulma anında mevcut olan verilerden yerel olarak üretilir ve gecikmeli veya yedek veri kullanabilir.",
