/* ============================================================
   data.jsx — deterministic mock market data + portfolio math
...
const DEFAULT_LOTS = { AAPL: 120, MSFT: 60, NVDA: 240, VTI: 180, BND: 400 };
...
function lookup(t) { return UNIVERSE.find(u => u.t === t); }
...
function createMarketDataAdapter(sourceId = "mock") {
...
const ACTIVE_DATA_ADAPTER = createMarketDataAdapter("mock");
...
// holdings: [{t, lots}]
function emptyPortfolio(profile = "balanced", source = DATA_SOURCES.mock) {
...
function buildPortfolio(holdings, opts = {}) {
...
function optimize(assets, mode, rf = 0.043) {
...
function monteCarlo(annRet, annVol, startValue, years, paths, seed) {
...
Object.assign(window, {
  UNIVERSE, DEFAULT_LOTS, DATA_SOURCES, ACTIVE_DATA_ADAPTER,
  lookup, corr, createMarketDataAdapter,
  buildPortfolio, emptyPortfolio, optimize, monteCarlo, STRESS, NEWS, COMPANY, GLOSSARY,
});
