/* ============================================================
   views-overview.jsx - Overview + Risk tabs
   Recreated to match the Claude Design component system.
   ============================================================ */
...
function dataProviderLabel(provider, language) {
...
function dataProviderTone(provider) {
  const p = (provider || "").toLowerCase();
...
function OverviewTab({ p, language = "tr" }) {
...
function RiskTab({ p, language = "tr" }) {
  const copy = RISK_COPY[language] || RISK_COPY.tr;
...
Object.assign(window, { OverviewTab, RiskTab, dataProviderLabel, dataProviderTone });
