...
function Sidebar(props) {
  ...
  const lookupInstrument = t => universe.find(u => u.t === t) || lookup(t);
  ...
  function add(t) { if (!held.has(t)) onAdd(t); setQ(""); setOpen(false); }
...
Object.assign(window, { Sidebar, Icon, PROFILES });
